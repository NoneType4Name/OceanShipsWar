...
run_with_links = namespace_args.links if namespace_args.links is not None else True if reg.get_value(
    reg.HKEY_CLASSES_ROOT, r'osw\shell\open\command', None) else False
...
Language = Language(DEFAULT_LANGUAGES.keys(), DEFAULT_LANGUAGES.values(), DEFAULT_LANGUAGE)
Settings = DATA({
    'Graphic': {
...
if theme == THEME_LIGHT:
    Colors = DATA({
        ...
        'ButtonActive': ((0, 0, 0), (164, 163, 162), (23, 21, 19), (0, 0, 0), (164, 163, 162), (23, 21, 19)),
    ...
    Colors = DATA({
        ...
        'ButtonActive': ((255, 255, 255), (91, 92, 93), (232, 234, 236), (255, 255, 255), (91, 92, 93), (232, 234, 236)),
